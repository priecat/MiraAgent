...
/**
 * BasicTickAgent - 基于 tick 状态机的 Agent（BasicAgent 的逐步重构）
 *
 * @discription
 *
 * @created 2026/8/16 14:15
 */

@Slf4j
public class BasicTickAgent implements IBasicAgent {
    ...
    public BasicTickAgent(AgentContextHolder contextHolder) {
        this(contextHolder, IdGen.uuidShort(), false);
    }

    public BasicTickAgent(AgentContextHolder contextHolder, String name) {
        this(contextHolder, name, false);
    }

    public BasicTickAgent(AgentContextHolder contextHolder, String name, boolean main) {
    ...
    public synchronized BasicTickAgent setMainAgent(boolean main) {
        this.mainAgent = main;
        if (main) {
